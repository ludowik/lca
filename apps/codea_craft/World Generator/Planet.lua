...
function Planet:init(entity, radius, gridSize, maxLod, atmos)
    ...
    self.material = craft.material(asset.StandardSphere)
    ...
    self.ocean.material = craft.material(asset.builtin.Materials.Standard)
    ...
    if atmos then
        ...
        self.atmos.material = craft.material(asset.Atmosphere)
