function unrefJoin(joint)
    physics.joints[ffi.cast('b2Joint*', joint)] = nil
end

local b2Joint_index = {
    destroy = function (self)
        if physics.joints[ffi.cast('b2Joint*', self)] then
            physics.joints[ffi.cast('b2Joint*', self)] = nil
            box2d.b2Joint_gc(physics, self)
        end
    end,
}
