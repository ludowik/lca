...
function Application:__mouseMove(...)
    if _G.env.mouseMove then
        return _G.env.mouseMove(...)
    else
...
function Application:mouseMove(mouse)
    if not self.ui:mouseMove(mouse) then
        if not self.scene:mouseMove(mouse) then
        end
    end
end

function Application:mouseWheel(mouse)
    if not self.ui:mouseWheel(mouse) then
        if not self.scene:mouseWheel(mouse) then
        end
    end
end
