...
function Node:mouseMove(mouse)
    local who = self:contains(mouse)
    if who and who.mouseMove then
        return who:mouseMove(mouse)
    end
end

function Node:mouseWheel(mouse)
    local who = self:contains(mouse)
    if who and who.mouseWheel then
        return who:mouseWheel(mouse)
    end
end
