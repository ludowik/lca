...
local id = ID("FileTree.CollapseAll")
return {
    name = "FileTree Collapse plugin",
    description = "FileTree Collapse",
    author = "Ludovic MILHAU",
    version = 0.1,

    onRegister = function(self)
        local tb = ide:GetToolBar()
        tb:AddSeparator()
        tool = tb:AddTool(id, "FileTree Collapse", wx.wxBitmap({
