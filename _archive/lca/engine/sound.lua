...
function al:alBufferData()
    return 1
end

function al:alSourceStop()
end

function al:alSourcei()
end

function al:alSourcef()
end

function al:alListener3f()
end

function al:alSourcePlay()
end
